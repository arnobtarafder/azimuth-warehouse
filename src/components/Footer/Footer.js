        ...
        <div className="row">
          <div className="col-lg-3 col-md-6 col-sm-6">
            <div className="widget company-intro-widget">
              <a href="index.html" className="site-logo"><img src="https://cdn-icons-png.flaticon.com/128/7142/7142160.png" alt="logo" /></a>
          ...
          <div className="col-lg-3 col-md-6 col-sm-6">
            <div className="widget course-links-widget text-start">
